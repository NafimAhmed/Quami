...
public class PH_detection extends AppCompatActivity {
    ...
    public TensorImage loadImage(Bitmap bitmap)
    {
        ...
        ImageProcessor imageProcessor =
                new ImageProcessor.Builder()
                        ...
                        .add(new ResizeOp(imageSizeX, imageSizeY, /*ResizeOp.ResizeMethod.BILINEAR*/ResizeOp.ResizeMethod.NEAREST_NEIGHBOR))
    ...
    public MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        ...
        try {
            AssetFileDescriptor fileDescriptor=activity.getAssets().openFd("ph27model.tflite");
    ...
    public void showresult()
    {
        try
        {
            labels= FileUtil.loadLabels(getApplicationContext(),"ph27labels.txt");
        ...
        for (Map.Entry<String, Float> entry : labeledProbability.entrySet()) {
           /* if(maxValueInMap<=0)
            ...
            if (entry.getValue()==maxValueInMap) {
                ...
                float accuracy=maxValueInMap*100;
                tv.setText(entry.getKey()+"  "+String.format("\n Accuracy: %.2f", accuracy)+"%");
            }
    ...
    public void classify(View v)
    {
        ...
        clearApplicationData();  //for cleaning cashe
