...
public class Ammo_Sea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ammo_sea);
    ...
    public MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        ...
        try {
            AssetFileDescriptor fileDescriptor=activity.getAssets().openFd("Ammo_Sea_1_model.tflite");
    ...
    public void showresult()
    {
        try
        {
            labels= FileUtil.loadLabels(getApplicationContext(),"Ammo_Sea_1_labels.txt");
